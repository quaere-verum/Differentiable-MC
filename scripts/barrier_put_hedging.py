...
from dmc.products.barrier_option import DownAndOutPutOption
from dmc.control.mlp_controller import MlpController
from dmc.feature_extraction.barrier_feature_extractor import DownAndOutPutFeatureExtractor, VarianceFeatureType
...
def get_or_compute_initial_cash(
    ...
    *,
    ...
    premia_path = output_root / "barrier_put.json"
